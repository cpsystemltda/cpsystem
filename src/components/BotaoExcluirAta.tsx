...
import { excluirAtaAction } from "@/app/actions/contratacoes";

// Botão de excluir Ata com confirmação inline. Igual ao fluxo dos contratos.
// A action `excluirAtaAction` impede a exclusão se houver contratos/empenhos
// vinculados; nesse caso a mensagem de erro vem do servidor.
export function BotaoExcluirAta({ ataId }: { ataId: string }) {
  ...
  if (!aberto) {
    return (
      <button
        ...
        style={{ height: "36px" }}
        title="Excluir esta Ata definitivamente"
      >
