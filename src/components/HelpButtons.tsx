    ...
    <>
      <div className="grid gap-1.5">
        <button
          ...
          className="flex items-center gap-2.5 rounded-lg border border-emerald-200 bg-gradient-to-r from-emerald-50 to-teal-50 px-3 py-2 text-sm font-medium text-emerald-800 transition hover:border-emerald-300 hover:shadow-sm"
        >
        ...
        <button
          ...
          className="flex items-center gap-2.5 rounded-lg border border-blue-200 bg-gradient-to-r from-blue-50 to-indigo-50 px-3 py-2 text-sm font-medium text-blue-800 transition hover:border-blue-300 hover:shadow-sm"
        >
      ...
      {aberto && (
        <Modal aberto={aberto} onClose={() => setAberto(null)} />
      )}
    </>
  );
}
...
function ContentManual() {
  const secoes = [
    { t: "Primeiros passos", d: "Como cadastrar sua primeira empresa, vincular um analista e configurar a equipe." },
    { t: "Cadastrar uma Ata via PDF", d: "Use a IA pra extrair número, processo, órgão, vigência e itens em segundos." },
    { t: "Derivar contratos e empenhos", d: "Como cada novo cadastro abate o saldo da Ata automaticamente." },
    { t: "Acompanhar a execução", d: "Linha do tempo logística — do empenhado ao pagamento." },
    { t: "Painel do analista", d: "Comissão calculada por execução paga, fixo mensal e ranking de empresas." },
