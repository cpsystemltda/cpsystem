...
const ROTAS: Rota[] = [
  ...
  { label: "Conciliação bancária", href: "/conciliacao", icon: Banknote, categoria: "Módulos", keywords: ["conciliacao", "banco", "extrato", "pagamento", "recebimento", "pix"], visivelPara: ["EMPRESA"] },
