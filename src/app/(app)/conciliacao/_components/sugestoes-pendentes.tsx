...
export function SugestoesPendentes({ sugestoes }: { sugestoes: Sugestao[] }) {
  if (sugestoes.length === 0) return null;
  return (
    <section className="mt-10">
      <h2 className="text-lg font-semibold text-slate-900">
        Sugestões pendentes de revisão ({sugestoes.length})
      </h2>
      <p className="mt-1 text-sm text-slate-600">
        Casos onde a gente encontrou um empenho compatível mas não teve certeza
        pra conciliar automaticamente. Revise e aprove/rejeite.
      </p>
