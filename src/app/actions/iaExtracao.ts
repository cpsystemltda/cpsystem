...
// NOTA: maxDuration nao pode ser exportado deste arquivo (server actions
// so aceitam exports de async functions). Timeout estendido configurado
// em vercel.json -> functions[].maxDuration=60.
